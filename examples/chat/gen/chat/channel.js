 ...
 * @description ChangeName is sent from client to server and then broadcasted by server to all clients
*/
 ...
 * @description Message is sent from client to server and broadcasted to other clients
*/
